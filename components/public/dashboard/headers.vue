            ...
            <v-row class="align-center justify-space-between pt-md-7 ">
                <v-col cols="12" md="5" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000"
                    ...
                    <div class="d-flex align-center mb-6">
                        ...
                        <h6 class="text-subtitle-1 text-dark font-weight-bold">Vision & Mission</h6>
                    </div>
                    <h1 class="text-h1 text-dark mb-6">The Asian energy company at the heart of innovation, technology, and sustainability</h1>
                    <p class="text-body-1 text-muted mb-8">Banpu Public Company Limited</p>
                ...
                <v-col cols="12" md="6" class="mt-md-0 mt-3">
                    <div class="position-relative text-center text-lg-start">
                        ...
                        <div class="position-relative z-index1 rounded-md overflow-hidden">
                            <img src="/images/corporate/Banpu.jpg" alt="banner" class="img-fluid rounded-md" />
                        </div>
